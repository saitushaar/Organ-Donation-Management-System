...
<div class="container-fluid">
	<form action="" id="manage-donation">
		...
		<div class="form-group">
			...
			<input type="text" class="form-control" step="any" name="volume"  value="<?php echo isset($volume) ? $volume :'' ?>" required>
		</div>
		<div class="form-group">
	        <label for="" class="control-label">Organ Donated</label>
			<select name="organ" id="" class="custom-select select2" required>
			    <option <?php echo isset($organ) && $organ == 'Blood' ? ' selected' : '' ?>>Blood</option>
