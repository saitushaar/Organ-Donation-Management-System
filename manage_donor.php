...
<div class="container-fluid">
	<form action="" id="manage-donor">
		...
		<div class="form-group">
			...
			<input type="text" class="form-control" name="history"  value="<?php echo isset($history) ? $history :'' ?>" required>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<input type="text" class="form-control" name="relative"  value="<?php echo isset($relative) ? $relative :'' ?>" required>
		</div>
		<div class="form-group">
